...
export default function AdminLogin() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2) OPTIONAL but recommended: check role in Firestore
            ...
            if (role !== "admin") {
                ...
                // You can also sign out here if you want.
                return;
            }
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            // Using the same logic as signup: create or merge the user doc with role: "admin"
            await setDoc(
